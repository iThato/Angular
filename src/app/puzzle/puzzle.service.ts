...
export class PuzzleService {
  ...
  puzzleImage: string;
  images = [
    prefixPath('../../assets/dvt.png'),
    prefixPath('../../assets/lollipop.jpg'),
    prefixPath('../../assets/fox.jpeg'),
    prefixPath('../../assets/Wolves.jpg'),
    prefixPath('../../assets/fox3.jpg')
  ];
  ...
  initialize() {
    ...
    let tileIndex = 0;
    for (let x = 0; x < 3; x++)//3 & 2
      for (let y = 0; y < 3; y++)//3 & 2
